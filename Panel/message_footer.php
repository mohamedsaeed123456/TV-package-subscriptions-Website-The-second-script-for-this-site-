...
$msg=$_POST['msg'];
$result=mysqli_query($link,"update message_footer set msg='$msg'  ");

if($result){
     echo "<script>alert('تم تغيير حقوق الموقع بنجاح '); 
        	      </script>";
}
    }
...
<section class="page-content">
  ...
  <section class="grid">
      ...
      <?php 
include 'connection.php';
$result=mysqli_query($link,"Select * from message_footer");
            while($row =mysqli_fetch_array($result)){
            ?>
         <div class="box">
        
        <h2>اضافة حقوق الموقع</h2>

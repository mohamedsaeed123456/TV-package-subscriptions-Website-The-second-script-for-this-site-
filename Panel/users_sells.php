...
<section class="page-content">
  ...
  <section class="grid">
    <?php 
    include 'connection.php';
     $result4=mysqli_query($link,"Select * from code_after_pay");
        if(mysqli_num_rows($result4) ==0){
             echo '<div class="area">⚠ لا يوجد مبيعات حتي الان  ⚠</div>';
        }
        else{
    ?>
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">اسم العضو</div>
        <div class="st_column _name">رقم جوال العضو</div>
        <div class="st_column _surname">البريد الالكتروني للعضو</div>
        <div class="st_column _year">الاشتراكات</div>
        <div class="st_column _section">كود الاشتراك</div>
          <div class="st_column _section">رقم الطلب</div>
        <div class="st_column _section">الحالة</div>
        <div class="st_column _section">تاريخ انهاء الدفع</div>
    ...
    <div class="st_table">
        <?php 
        include 'connection.php';
        $result=mysqli_query($link,"Select * from code_after_pay");
        while($row = mysqli_fetch_array($result)){
        ?>
      <div class="st_row">
        <div class="st_column _rank"> 
        <?php echo $row['FirstName']; echo ' '; echo $row['LastName'];?>
        </div>
        <div class="st_column _name">
            <?php
            echo $row['CCODE']; echo $row['PHONE'];
            ?>
            </div>
      ...
      <a href="delete5.php?Del=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button> </a>
        </div>
      </div>
    <?php }
    ?>

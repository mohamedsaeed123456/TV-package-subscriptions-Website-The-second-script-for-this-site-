...
$msg=$_POST['msg'];
$result=mysqli_query($link,"update message1 set msg='$msg'  ");

if($result){
     echo "<script>alert('تم تغيير الرسالة الموجودة اسفل الصفحة الرئيسية بنجاح'); 
        	      </script>";
}
    }
...
<section class="page-content">
  ...
  <section class="grid">
      ...
      <?php 
include 'connection.php';
$result=mysqli_query($link,"Select * from message1");
            while($row =mysqli_fetch_array($result)){
            ?>
         <div class="box">
        
        <h2>تغيير الرسالة الموجودة اسفل الصفحة الرئيسية</h2>

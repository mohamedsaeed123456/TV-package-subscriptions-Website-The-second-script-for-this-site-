...
<section class="page-content">
  ...
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">رقم الزائر</div>
        <div class="st_column _name">ip الزائر</div>
        <div class="st_column _name">تاريخ الزيارة</div>
          <div class="st_column _section">تحديث</div>
      </div>
    </header>
    <?php
      include 'connection.php';
      $result16 = mysqli_query($link,"select * from ip_visitor");
      if(mysqli_num_rows($result16) >0){
      ?>
    <div class="st_table">
      <?php
      include 'connection.php';
      $result13 = mysqli_query($link,"select * from ip_visitor");
      ...
      <a href="delete6.php?Del=<?php echo $row13['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button> </a>
        </div>
      </div>
      <?php } ?>
  ...
  <?php }
    ...
    echo '<p style="margin-left:200px;font-size:25px;">لا يوجد زوار حتي الان في الموقع </p>';
}
?>
  </div>
</main>
   ...
   <div class="col-lg-12">
                                ...
                                <div  class="col-12">
                                    <div  class="quick_activity_wrap">
                                        <div class="single_quick_activity d-flex">
                                            <div  class="icon">
                                                <img src="images1/man.png" alt="">
                                            </div>
                                          
                                            <div class="count_content">
                                                <h3><span class="counter"><?php 
                                                include 'connection.php';
                                                $result12 = mysqli_query($link,"Select * from pay_info");
        ...
        <article>
           <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="quick_activity_wrap">
                                        <div class="single_quick_activity d-flex">
                                            <div class="icon">
                                                <img src="images1/visitors.png" alt="">
                                            </div>
                                            <div class="count_content">
			...
			$result15 = mysqli_query($link,$qry1);
			$row1 = mysqli_fetch_array($result15, MYSQLI_ASSOC);
			$count = $row1['visits'];
            echo $count;
        ?>

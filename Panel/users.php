  ...
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        ...
        <div class="st_column _section">سعر الاشتراكات</div>
          <div class="st_column _section">السعر الكلي</div>
    ...
    <div class="st_table">
        <?php 
        include 'connection.php';
        $result=mysqli_query($link,"Select * from pay_info");
      ...
      <div class="st_row">
        ...
        <div class="st_column _name">
            <?php
            echo $row['ccode4']; echo $row['phone'];
            ?>
            </div>
        <div class="st_column _surname">
        <?php
               echo $row['email_verification'];
        ?>
        </div>
        ...
        <a href="edit_users.php?GETID=<?php echo $row['id']; ?> "> <button class="glow-on-hover" type="button">تعديل</button></a>
      <a href="delete4.php?Del=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button> </a>
        </div>
      </div>
    <?php } ?>

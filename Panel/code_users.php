...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">البريد الالكتروني</div>
    ...
    <div class="st_table">
        ...
        ?>
      <div class="st_row">
      <div class="st_column _rank"><?php  echo $row['email']; ?></div>
      <div class="st_column _rank"><?php echo $row['code_verification']; ?></div>
        <div class="st_column _section">
      <a href="delete11.php?DEL=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button>
</a>
        </div>
         </div>
         <?php } ?>

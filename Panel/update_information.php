...
<header class="page-header">
  <nav>
   ...
   <ul class="admin-menu">
      ...
      ?>
        <li>
        <a href="information.php?ID=<?php echo $row33['id']; ?>">
          <svg>
            <use xlink:href="#pages"></use>
          </svg>
...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">اسم الصفحة الفرعية</div>
         <div class="st_column _rank">المعلومات</div>
    ...
    <div class="st_table">
        <?php 
        include 'connection.php';
        $result=mysqli_query($link,"Select * from information inner join sub_pages_names on information.id_sub_pages = sub_pages_names.ids  ");
        while($row = mysqli_fetch_array($result)){
        ?>
      <div class="st_row">
        <div class="st_column _rank"><?php echo $row['name']; ?></div>
        <div style="color:white;"class="st_column _rank">
          <p ><?php echo $row['editor'];  ?></p>

            </div>
      
        <div class="st_column _section">
         <a href="edit_information.php?GetId=<?php echo $row['id'];?>">   <button class="glow-on-hover" type="button">تعديل</button></a>
      <a href="delete8.php?DEL=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button>
</a>
        </div>
      </div>
      <?php  } ?>

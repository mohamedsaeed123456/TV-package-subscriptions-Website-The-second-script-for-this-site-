...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">صورة البنر</div>
    ...
    <div class="st_table">
      ...
      <div class="st_row">
        <div class="st_column _rank">
             <?php echo '<img width="50" height="50" class="lazyloaded" src="data:image;base64 ,'.$row['img'].'" >';?>
        </div>
      
        <div class="st_column _section">
         <a href="update_panners.php?GetId=<?php echo $row['id'];?>">   <button class="glow-on-hover" type="button">تعديل</button></a>
      <a href="delete2.php?DEL=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button>
</a>
        </div>
      </div>
    <?php } ?>

...
$editor=$_POST['editor'];
$id_sub_pages=$_GET['ID'];
$result=mysqli_query($link,"insert into information(editor,id_sub_pages) values('$editor','$id_sub_pages')");
if($result){
    echo '<script>alert("تم ارسال المعلومات بنجاح")</script>';
}
}
?>
...
<head>
     <?php 
      include 'connection.php';
      $id=$_GET['ID'];
      $result33 = mysqli_query($link,"select * from sub_pages_names where ids='$id'");
		...
		<div class="container-contact2">
			<div class="wrap-contact2">
					...
					<div class="wrap-input2 validate-input" data-validate = "Message is required">
                              ...
                              <?php $content_row=0 ; ?>
                              <textarea class="form-control" id="code_preview0" name="editor" style="height: 300px;"></textarea>
                              <?php $content_row++; ?>
<!-- Page - Content End -->
                   </div>

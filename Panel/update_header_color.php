...
$color=$_POST['color'];
$result=mysqli_query($link,"update header set background_color='$background_color'  ");

if($result){
     echo "<script>alert('تم تغيير لون خلفية الهيدر بنجاح'); 
        	      </script>";
}
    }
...
<section class="page-content">
  ...
  <section class="grid">
      ...
      <?php 
include 'connection.php';
$result=mysqli_query($link,"Select * from header");
            while($row =mysqli_fetch_array($result)){
            ?>
         <div class="box">
        
        <h2>تغيير لون خلفية الهيدر</h2>

<?php 
  ...
  $query="select * from code_shares where id= '".$id."'";
...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <form method="post" action="update3.php?ID=<?php echo $id1 ?>" enctype="multipart/form-data">
...
$result=mysqli_query($link,"Select * from add_share");
            ...
            <div class="inputBox">
             <input type="text" id="code" value="<?php echo $code ?>" name="code" required="">

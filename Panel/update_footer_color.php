...
$result=mysqli_query($link,"update footer set background_color='$background_color'  ");

if($result){
     echo "<script>alert('تم تغيير لون خلفية الفوتر بنجاح'); 
        	      </script>";
}
    }

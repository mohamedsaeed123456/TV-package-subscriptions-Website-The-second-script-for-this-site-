...
<main class="st_viewport">
  <div class="st_wrap_table" data-table_id="0">
    <header class="st_table_header">
      <div class="st_row">
        <div class="st_column _rank">رقم الجوال</div>
        <div class="st_column _rank">كود التحقق</div>
    ...
    <div class="st_table">
        <?php 
        include 'connection.php';
        $result=mysqli_query($link,"Select * from sms");
        while($row = mysqli_fetch_array($result)){
        ?>
      <div class="st_row">
      <div class="st_column _rank"><?php echo $row['ccode1']; echo $row['phone']; ?></div>
      <div class="st_column _rank"><?php echo $row['code_verification']; ?></div>
        <div class="st_column _section">
      <a href="delete9.php?DEL=<?php echo $row['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button>
</a>
        </div>
         </div>
         <?php } ?>
        <?php 
        include 'connection.php';
        $result1=mysqli_query($link,"Select * from sms1");
        while($row1 = mysqli_fetch_array($result1)){
        ?>
      <div class="st_row">
      <div class="st_column _rank"><?php echo $row1['ccodee']; echo $row1['phone']; ?></div>
      <div class="st_column _rank"><?php echo $row1['code_verification']; ?></div>
        <div class="st_column _section">
      <a href="delete10.php?DEL=<?php echo $row1['id']; ?>"> <button class="glow-on-hover" type="button">حذف</button>
</a>
      </div>
      </div>
    <?php } ?>

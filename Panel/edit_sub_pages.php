<?php 
  ...
  $query="select * from sub_pages_names where id= '".$id."'";
...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <h2>تعديل الصفحات الفرعية</h2>
        
        <form method="POST" action="update5.php?Id=<?php echo $id1 ?>">
            <div class="inputBox">
             <input type="name" id="name" value="<?php echo $name ?>" name="name" required="">
             <label>اسم الصفحة الفرعية</label>
            </div>

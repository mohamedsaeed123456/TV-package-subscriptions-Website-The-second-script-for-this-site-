...
include 'connection.php';
   $description = stripcslashes($_POST['description']);
    $code=stripcslashes($_POST['code']);
      $result = mysqli_query($link,"insert into code_shares(description,code) values ('$description','$code')");
         
          if($result){
        	      echo "<script>alert(' تم اضافة كود الدفع بنجاح')</script>";
          }
         else{
        	      echo "<script>alert('حدث خطأ ما اثناء اضافة الكود')</script>";
          }
        }
  ...
  <section class="grid">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="inputBox">
               ...
               <select style="background-color:#242e42;" dir="rtl" name="description" id="description">

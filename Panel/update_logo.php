...
include 'connection.php';
 ...
 if(isset($_POST['submit'])){
    $image= base64_encode(file_get_contents($_FILES['logo']['tmp_name']));
    
     $query="UPDATE logo set logo='".$image."' ";
     $result=mysqli_query($link,$query);
     if($result){
     	   
         echo "<script>alert(' تم تعديل الشعار بنجاح') ;
         </script>";
     }

...
<section class="page-content">
  ...
  <section class="grid">
        ...
        <form method="post" action="update4.php?ID=<?php echo $id1 ?>" enctype="multipart/form-data">
            
            <div class="inputBox">
             <input type="text" id="first_name"value="<?php echo $first_name ?>" name="first_name" required="">
             <label>الاسم الاول للعضو</label>
            </div>
            <div class="inputBox" >
                <input type="text"id="last_name" value="<?php echo $last_name ?>" name="last_name" required="">
                <label>اسم العائلة للعضو</label>
            </div>
           
            <div dir="rtl" class="inputBox">
                <input type="hidden" id="ccode1" name="ccode4">
             <input required=""  id="phone" name="phone" value="<?php echo $ccode; echo $phone ?>" type="tel">
                <label>رقم جوال العضو</label>
            </div>
             <br> <br>
            <div class="inputBox">
                <input type="text"id="email_verification" value="<?php echo $email_verification ?>" name="email_verification" required="">
                <label>البريد الالكتروني للعضو</label>
            </div>
             <div class="inputBox">
             ...
             <div class="inputBox">
                <input type="text"id="price_product" value="<?php echo $price_product ?>" name="price_product" required="">
                <label>سعر الاشتراكات</label>
            </div>
            <div class="inputBox">
                <input type="text"id="product_price" value="<?php echo $product_price ?>" name="product_price" required="">
                <label>السعر الكلي للاشتراكات</label>
            </div>
